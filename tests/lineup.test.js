import{lineupSnapshot,moveOrSwap,resetToDraftedPositions,restoreSnapshot,validateDraftArrangement,validateLineup,isLineupEditable}from'../js/lineup.js?v=20260726-era-coverage-1';import{calculateTeamRatings}from'../js/ratings.js?v=20260726-era-coverage-1';import{draftRosterView,playerDraftView}from'../js/draft-board.js?v=20260726-era-coverage-1';import{wheelView}from'../js/wheel.js?v=20260726-era-coverage-1';import{validatePlayerPositions}from'../js/data-validator.js?v=20260726-era-coverage-1';
...
export const lineupTests=[
 ...
 ['Drafted player card shows the reusable overall badge',()=>{const html=draftRosterView({roster:makeRoster().slice(0,1)},null);return html.includes('<span class="overall-badge"><small>OVR</small>85</span>')&&!html.includes('Overall: 85')}],
